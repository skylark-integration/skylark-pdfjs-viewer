requirejs.config({
    ...
    paths: {
      ...
      packages: [
         ...
         {
           name : "skylark-langx-exceptions",
           location : "../node_modules/skylark-langx-exceptions/dist/uncompressed/skylark-langx-exceptions",
            main: 'main'
         },
         {
         ...
         },
         {
          ...
          {
            name: 'skylark-io-streams',
            location : "../node_modules/skylark-io-streams/dist/uncompressed/skylark-io-streams",
            main: 'main'
          },   
          {
            name: 'skylark-graphics-jpeg',
            location : "../node_modules/skylark-graphics-jpeg/dist/uncompressed/skylark-graphics-jpeg",
            main: 'main'
          }, 
          {
            name: 'skylark-pdfjs-display',
            location : "../node_modules/skylark-pdfjs-display/dist/uncompressed/skylark-pdfjs-display",
            main: 'main'
          },  
          {
            name: 'skylark-pdfjs-worker',
            location : "../node_modules/skylark-pdfjs-worker/dist/uncompressed/skylark-pdfjs-worker",
            main: 'main'
          },  
          {
            name: 'skylark-pdfjs-viewer',
            location : "../src",
            main: 'main'
          }      
        ]
...
require(["skylark-pdfjs-worker"], function (worker) {
    require("skylark-pdfjs-worker");
    require(["skylark-pdfjs-viewer/viewer_bundled"], function (viewer) {
        if (window.initPage) {
